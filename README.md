...
Permission-to-User Matrix: [UPA.txt](CompleteS/F/MaxHS/Results.txt) 
Permission-to-Role Matrix: [PA.txt](CompleteS/F/MaxHS/Results.txt) 
User-to-role Matrix: [UA.txt](CompleteS/F/MaxHS/Results.txt) 
